...
tool: idumb-validate
scope: all
output: save to .idumb/brain/governance/initial-assessment-{timestamp}.json
...
```yaml
evidence_artifacts:
  initial_assessment: ".idumb/brain/governance/initial-{timestamp}.json"
  gap_classification: ".idumb/brain/governance/gaps-{timestamp}.json"
  resolution_plan: ".idumb/brain/governance/plan-{timestamp}.md"
  execution_log: ".idumb/brain/governance/execution-{timestamp}.json"
  final_report: ".idumb/brain/governance/report-{timestamp}.md"
