...
1. P1-3.1 → Session Tracking (foundation)
2. P1-3.2 → Tool Permissions (matrix)
3. P1-3.5 → First Tool Enforcement (critical)
4. P1-3.3 → Message Transform (session start)
5. P1-3.4 → Post-Compact (compaction)
6. P1-3.6 → Permission Auto-Deny (errors)
7. P1-3.7 → Event Lifecycle (cleanup)
