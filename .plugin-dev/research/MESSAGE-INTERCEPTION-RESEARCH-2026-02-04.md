...
| Score persistence | NOT IMPLEMENTED | `.idumb/sessions/{id}-score.json` | ❌ MISSING |
...
**File:** `.idumb/sessions/{sessionId}-score.json`
...
| File | Purpose |
|------|---------|
| `.idumb/sessions/{id}-score.json` | Accumulated score persistence |
| `.idumb/sessions/{id}-purify.json` | Purification context storage |
